...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_SECOND] = LAYOUT_fullsize_iso(
        ...
        KC_MS_BTN3, KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2, _______, _______, _______, _______, _______, _______, _______, _______, _______,             _______, _______, RGB_VAI,    _______, _______, _______,  _______,
        _______, KC_MS_LEFT, KC_MS_DOWN,KC_MS_LEFT, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                                  _______, _______, _______,
