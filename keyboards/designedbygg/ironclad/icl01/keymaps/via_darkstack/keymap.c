...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_fullsize_iso(
        ...
        _______, 0x700b, _______,                            _______,                            _______, _______, _______, _______,    RGB_SAI, RGB_HUI, RGB_SPI,    RGB_VAI,          _______
    ),
    ...
    [2] = LAYOUT_fullsize_iso(
        ...
        _______, 0x700b, _______,                            _______,                            _______, _______, _______, _______,    _______, _______, _______,    _______,          _______
    ),
};
