...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT_fullsize_extended_iso(
        QK_BOOT,          KC_MPLY, KC_MPRV, KC_MNXT, _______, _______, _______, _______, _______, _______, _______, _______, RGB_TOG,    _______, _______, _______, _______, _______, _______, _______,
        ...
        KC_MS_BTN3, KC_MS_BTN1, KC_MS_UP, KC_MS_BTN2, _______, _______, _______, _______, _______, _______, _______, RALT(KC_5), RALT(KC_MINS),             _______, _______, RGB_VAI,    _______, _______, _______,  _______,
        _______, KC_MS_LEFT, KC_MS_DOWN,KC_MS_RIGHT, _______, _______, _______, _______, _______, _______, _______,RALT(KC_4), RALT(KC_EQL), _______,                                  _______, _______, _______,
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,          MO(2),             RGB_MOD,             _______, _______, _______,  _______,
        _______, 0x700b, _______,                            _______,                            _______, KC_APP, _______, _______,    RGB_SAI, RGB_HUI, RGB_SPI,    _______,          _______
    ),
